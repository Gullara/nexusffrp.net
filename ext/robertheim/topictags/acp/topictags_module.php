	...
	private function handle_settings()
	{
		...
		if ($request->is_set_post('submit'))
		{
			...
			if ($commit_to_db)
			{
				...
				$garbage = $request->variable(prefixes::CONFIG . '_garbage_collection', 1);
				$config->set(prefixes::CONFIG . '_garbage_collection', $garbage);
		...
		$template->assign_vars(array(
			...
			'TOPICTAGS_GARBAGE_COLLECTION'           => $config[prefixes::CONFIG . '_garbage_collection'],
